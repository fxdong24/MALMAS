...
class Profiler:
    def __init__(
        ...
        """
        Args:
            log_dir     : folder path for sample json files.
            pkl_dir     : unused here.
    ...
    def _record_and_verbose(self, sample_orders: int):
        ...
        print('-----------------------------------------------------------')
        print(f'Score            : {score}')
        print(f'Sample Time      : {sample_time:.3f}s' if sample_time is not None else 'Sample Time      : None')
        print(f'Evaluation Time  : {evaluate_time:.3f}s' if evaluate_time is not None else 'Evaluation Time  : None')
        print(f'Total Samples    : {self._num_samples}')
        print(f'Legal Programs   : {self._evaluate_success_program_num}')
        print(f'Illegal Programs : {self._evaluate_failed_program_num}')
        print('===========================================================\n')
