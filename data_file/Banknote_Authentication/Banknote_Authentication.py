...
set_params(n_estimators=50)

class Banknote_Authentication:
    @staticmethod
    def read_data():
        """
        读取数据文件并完成以下步骤：

        1. 加载原始数据文件（默认路径为 "Banknote_Authentication.csv"）。
        ...
        csv_path = os.path.join(absolute_path, "Banknote_Authentication.txt")
